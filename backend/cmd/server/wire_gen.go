...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grsaiNativeClient := service.ProvideGrsaiNativeClient()
	...
	grsaiTaskService := service.ProvideGrsaiTaskService(grsaiSettlementRepository, grsaiTaskPayloadRepository, accountRepository, grsaiStreamClient, grsaiSettlementService)
